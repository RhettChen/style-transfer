...
def train(model, generated_image, initial_image, ITERS,model_load,trainable_signal):
    skip_step = 1
    with tf.Session() as sess:
...
def training(STYLE_IMAGE,CONTENT_IMAGE,LR,ITERS,NOISE_RATIO,model_load,trainable_signal):
